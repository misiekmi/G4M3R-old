    ...
    if (suffix) {
        if (suffix.toLowerCase() == "add") {
                ...
                db.events.create({
                    ...
                    if (err) {
                        ...
                        QueryHelper.findServerEvents(db, serverDocument._id).then((eventDocuments) => {
                            let viewer = new EventViewer(bot, msg, db, serverDocument, eventDocuments, msg.member, page_size);
            ...
            QueryHelper.findServerEvents(db, serverDocument._id).then((eventDocuments) => {
                ...
                viewer = new EventViewer(bot, msg, db, serverDocument, eventDocuments, msg.member, page_size);
